...
The complete setup and the application of the ArdPicProg is described in more detail on http://makerprojects.de/2017/10/arduino-pic-programmer/. This page also features a comprehensive User's Guide.
